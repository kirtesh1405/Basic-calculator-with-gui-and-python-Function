...
result_label.grid(row=0,column=0,columnspan=5,sticky='e',pady=(50,25))
...
btn_multy = Button(root,text="X",bg='#00a65a',fg='white',width=5,height=2,command=lambda :get_operator('*'))
btn_multy.grid(row=3,column=3)
btn_multy.config(font=('verdana',14))
